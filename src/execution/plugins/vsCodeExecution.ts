...
import {
  ...
  textLinkNodeData,
  zip,
  CodingQuestionNodeData,
} from "./Node";

type vsCodeSpecifics = {
...
export function vsCodeExecution(node: PolyglotNode) {
  let vsCodeSpecifics: vsCodeSpecifics = {
    challengeSetup: [],
    challengeContent: [],
  };
